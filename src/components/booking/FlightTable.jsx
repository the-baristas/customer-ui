            ...
            <Col xs={12} lg={3}>
             ...
             <Card className="upgrade-dep-bg">
                ...
                <Card.Title>Upgrade Boarding Group?</Card.Title>
                    ...
                    <Card.Link className="point" onClick={() => handleUpgrade(15, 1)}>Upgrade To Group 1</Card.Link>
                    { props.checkInGroup !== 2 && <Card.Link className="point" onClick={() => handleUpgrade(12, 2)}>Upgrade To Group 2</Card.Link> }
                </Card.Body>
               </Card> }
